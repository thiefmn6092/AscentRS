...
public enum LoginState {
	...
	/*
	 * The server reads the derived name hash from the client and then sends a
	 * response.
	 */
	INITIAL_RESPONSE,
	...
	/*
	 * When the login block has been decoded. The session does NOT have to be
	 * authenticated to hold this state.
	 */
	COMPLETE;
